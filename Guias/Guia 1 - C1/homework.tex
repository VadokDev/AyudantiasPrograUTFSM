...
\newcommand{\hmwkTitle}{Guía 1 -- Diagramas de Flujo}
\newcommand{\hmwkDueDate}{24/01/2018}
...
\begin{homeworkProblem} {McDonald's}
    ...
    3 & \texttt{Papas Fritas} & \$3.000 \\
    2 & \texttt{Bebida} & \$10.000  \\
    2 & \texttt{Hamburguesa} & \$4.000 \\ \hline
    & Descuentos & \$2.700 \\
    & Total Final: & \$14.300\\ \hline
    \end{tabular}
    \caption*{Tabla 2. Ejemplo de Detalle de Compra*}
    \end{table}
    \end{center}

    Realiza un \texttt{Diagrama de Flujo} y un \texttt{Código Python} que realicen lo solicitado anteriormente, puedes realizar las suposiciones que consideres necesarias para resolver cualquier posible inconsistencia con el enunciado.\\

    \solution

    \vfill
    \small{*Nota: Para el ejemplo anterior, se asume que el orden en que se compraron las cosas fue papas fritas -- bebida (\$-200) -- papas fritas -- hamburguesa -- bebida (\$-2500) -- hamburguesa -- papas fritas.}
...
\begin{homeworkProblem} {PyTube}
    La famosa plataforma de videos \texttt{PyTube} contrató una enorme cantidad de filósofos, humanistas, raperos y un matemático para realizar un estúdio acerca de cómo aumentar la cantidad de tiempo que invierte una persona interactuando con su plataforma con la finalidad de aumentar la distribución de anuncios y así monetizar más aún sus visitas.\\
